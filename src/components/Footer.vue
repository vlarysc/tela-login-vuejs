        ...
        <div class="row">
          <div class="col-md-3">
            <div id="footer-socials">
              <h1 class="meuH1">
                Criado por
                <strong style="font-family: 'Cookie', cursive; font-size: 60px"
                  >Manoel Neto</strong
                >
              </h1>
              <div class="socials inline-inside socials-colored">
                <a
                  href="https://www.facebook.com/profile.php?id=100033305901376"
                  target="_blank"
                  title="Facebook"
                  class="socials-item"
                >
                ...
                <a
                  href="https://www.instagram.com/manoelnetose/"
                  target="_blank"
                  title="Instagram"
                  class="socials-item"
                >
                ...
                <a
                  href="https://www.youtube.com/channel/UCkFMqbXB1h8lI-dXgc1kcVA"
                  target="_blank"
                  title="YouTube"
                  class="socials-item"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/vlarysc/"
                  target="_blank"
                  title="Linkedin"
                  class="socials-item"
                >
                  <i class="fab fa-linkedin likedin"></i>
                </a>
              </div>
            </div>
          </div>
